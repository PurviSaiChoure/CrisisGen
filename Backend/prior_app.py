...
multi_ai_agent.print_response(
    "Provide a detailed analysis of the current wildfire situation in LA during the last 7 days. Include affected areas, environmental impacts, and ongoing relief efforts. Include affected areas, environmental impacts, and ongoing relief efforts. Provide actionable recommendations for governments, NGOs, and individuals.",
    stream=True
)